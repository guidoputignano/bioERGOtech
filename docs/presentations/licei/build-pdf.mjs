/**
 * Prints the schools deck to a 16:9 PDF with Chromium, through Playwright.
 *
...
const SRC = path.join(HERE, 'licei-deck.html')
const OUT = path.join(HERE, 'Biotecnologie-e-IA-Rete-di-Scopo-2026-Presentazione-Scuole.pdf')
