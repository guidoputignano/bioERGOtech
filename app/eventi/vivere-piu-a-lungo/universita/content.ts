 ...
 * `licei/content.ts` e `bando/content.ts`. La fonte e il testo del bando del
 ...
 * referente che conferma: il destinatario e sempre e solo lo studente.
 */
...
/** Intestazione della pagina. Il sottotitolo e la sintesi dell'art. 1. */
...
export const PREMESSA = [
  "La Fondazione bioERGOtech, con direzione scientifica, e SafesPro, Scuola di Alta Formazione e Studi Specializzati per Professionisti, in qualita di ente organizzatore, indicono il presente bando per la partecipazione degli studenti universitari al percorso formativo e progettuale gratuito “Biotecnologie e Intelligenza Artificiale”.",
  "Il progetto si inserisce nel percorso avviato con i Taranto Biotech Days 2024 e con l'evento tenutosi a Roma il 28 e 29 ottobre 2025 presso la Sala della Regina di Palazzo Montecitorio, e prosegue con l'iniziativa “Vivere piu a lungo: sport e intelligenza artificiale”, nell'ottica di favorire, nel lungo periodo, l'insediamento di un centro di ricerca a Taranto.",
  "L'iniziativa nasce con l'obiettivo di creare un ponte tra formazione universitaria, ricerca scientifica, innovazione tecnologica e mondo dell'impresa, offrendo agli studenti la possibilita di approfondire le potenzialita dell'integrazione tra biotecnologie e intelligenza artificiale.",
  ...
  "Particolare attenzione sara dedicata alla capacita degli studenti di lavorare secondo un approccio scientifico, interdisciplinare e orientato alla ricerca, con il supporto di ricercatori, docenti, professionisti e mentor provenienti dal mondo accademico e imprenditoriale.",
  "Obiettivo finale del percorso sara l'elaborazione, da parte dei partecipanti, di un progetto scientifico originale, sotto forma di studio, proposta di ricerca, modello sperimentale o altra soluzione innovativa che integri biotecnologie e intelligenza artificiale.",
];
...
/**
 * Le aree disciplinari dell'art. 2. L'elenco del bando e esplicitamente "a
...
export const AREE_DISCIPLINARI = [
  ...
  { value: "altro", label: "Altra disciplina coerente con le finalita del progetto" },
] as const;
...
export const DESTINATARI_NOTE = [
  "Il percorso e rivolto agli studenti universitari iscritti a corsi di laurea triennale, magistrale, a ciclo unico, dottorato di ricerca o altri percorsi universitari e post-universitari, presso universita italiane o straniere.",
  "E espressamente incoraggiata la partecipazione di team interdisciplinari, composti da studenti provenienti da differenti percorsi di studio, al fine di favorire l'integrazione tra competenze scientifiche, tecnologiche, cliniche, progettuali e manageriali.",
];
...
export const CANDIDATURA_INDIVIDUALE_NOTA =
  "La partecipazione e individuale nella fase di candidatura e potra successivamente prevedere la costituzione di team di lavoro secondo modalita definite dagli organizzatori.";

/* ── Art. 3. Modalita di svolgimento ───────────────────────────────────── */

export const SVOLGIMENTO_NOTE = [
  "Il percorso sara realizzato secondo le modalita definite dagli organizzatori e potra prevedere attivita formative online e in presenza, al di fuori degli ordinari impegni universitari.",
  "Le attivita saranno svolte con il supporto di ricercatori, docenti universitari, esperti, professionisti e mentor provenienti dal mondo della ricerca, dell'innovazione e dell'impresa.",
];

/** I contenuti che il percorso potra comprendere, art. 3. */
export const CONTENUTI_PERCORSO = [
  ...
  "Applicazioni dell'IA alla salute, alla longevita e allo sport",
  ...
  "Valutazione della fattibilita tecnica e scientifica",
  "Aspetti etici, regolatori e di responsabilita nell'utilizzo dell'intelligenza artificiale e delle biotecnologie",
  ...
  "Criteri di qualita e requisiti per la pubblicazione su riviste scientifiche",
];

/* ── Art. 4. Modalita di adesione ──────────────────────────────────────── */

/**
 * Quello che la candidatura "potra prevedere" secondo l'art. 4, che lo dice
...
export const ADESIONE_NOTE = [
  ...
  "Nel caso di costituzione di team, sara favorita, ove possibile, la formazione di gruppi caratterizzati da interdisciplinarita e complementarita delle competenze.",
];
...
export const COSA_OFFRE = [
  ...
  },
  {
    ...
    desc: "La possibilita di confrontarsi con ricercatori, docenti, esperti e professionisti del settore.",
  },
  {
    icona: "fa-compass",
    titolo: "Mentoring",
    desc: "Attivita di mentoring e accompagnamento alla progettazione scientifica lungo tutto il percorso.",
  },
  {
    icona: "fa-users-gear",
    titolo: "Un progetto in team",
    desc: "La possibilita di sviluppare un proprio progetto di ricerca insieme ad altri studenti, anche di altre discipline.",
  },
  {
    icona: "fa-flask",
    titolo: "Metodo della ricerca",
    desc: "L'opportunita di acquisire competenze nella metodologia della ricerca scientifica e nella valutazione della fattibilita.",
  },
  {
    icona: "fa-file-lines",
  ...
  },
  {
    ...
    desc: "La possibilita di presentare il proprio lavoro davanti a una commissione scientifica.",
  },
  {
    icona: "fa-book-open",
    titolo: "Percorso di valorizzazione",
    desc: "La possibilita di valorizzare il lavoro prodotto attraverso un successivo percorso di sottomissione a una rivista scientifica.",
  },
];

export const PARTECIPAZIONE_GRATUITA_NOTA =
  "La partecipazione al percorso e completamente gratuita.";
 ...
 *
 * Unico punto in cui e descritto il premio: se la formula cambia, si cambia
 ...
 * qui perche la classificazione in fasce dell'ANVUR riguarda le riviste
 * dell'area umanistica e sociale e non si applica alle scienze della vita,
 * dove il riferimento riconosciuto e l'indicizzazione. La formula sotto dice
 * la stessa cosa in modo verificabile.
 */
export const PREMIO_TESTO =
  "Il miglior progetto, individuato dalla Commissione di valutazione, sara selezionato per un percorso finalizzato alla preparazione e alla proposta di pubblicazione del lavoro presso una rivista scientifica internazionale peer-reviewed, indicizzata Scopus o Web of Science, coerente con la tematica e la qualita scientifica del lavoro.";

export const PREMIO_SUPPORTO =
  "Il percorso potra prevedere il supporto di esperti e mentor nella revisione scientifica e nella predisposizione del manoscritto secondo gli standard richiesti dalla rivista individuata.";
...
export const PREMIO_CONDIZIONI = [
  "Alla qualita scientifica effettiva del lavoro",
...
export const PREMIO_NON_GARANZIA =
  "La selezione del progetto nell'ambito del presente bando non costituisce garanzia di pubblicazione, ma attribuisce al team vincitore la possibilita di intraprendere, con il supporto degli organizzatori e dei professionisti coinvolti, un percorso finalizzato alla sottomissione del lavoro a una rivista scientifica di rilievo.";

export const PREMIO_ULTERIORI =
  "Gli organizzatori potranno inoltre valutare, in funzione della qualita dei lavori presentati, la possibilita di accompagnare alla pubblicazione anche ulteriori progetti meritevoli.";
...
export const CRITERI_UNIVERSITA = [
  {
    nome: "Innovativita e originalita scientifica",
    punti: 25,
    desc: "Grado di novita dell'ipotesi, dell'approccio o della soluzione proposta rispetto allo stato dell'arte.",
  },
  {
    nome: "Solidita scientifica e metodologica",
    punti: 25,
    desc: "Qualita dell'impostazione scientifica, metodologia, dati, analisi e coerenza delle conclusioni.",
  },
  {
  ...
  },
  {
    ...
    punti: 15,
    desc: "Qualita e significativita dell'integrazione tra le due aree disciplinari.",
  },
  {
    nome: "Aspetti etici e responsabilita scientifica",
    punti: 10,
    desc: "Consapevolezza delle implicazioni etiche, normative e sociali connesse alla proposta.",
  },
  {
    nome: "Qualita della presentazione scientifica",
    punti: 5,
    desc: "Chiarezza, efficacia e capacita di comunicare il lavoro secondo criteri scientifici.",
  },
] as const;
...
export const CRITERIO_DIRIMENTE = "Innovativita e originalita scientifica";

export const REGOLA_PARITA = `A parita di punteggio complessivo prevale il progetto che ha ottenuto il punteggio piu alto nel criterio “${CRITERIO_DIRIMENTE}”. In caso di ulteriore parita decide il voto insindacabile del Presidente della Commissione.`;

export const CRITERI_NOTE = [
  "La Commissione potra tenere conto, ai fini della valutazione complessiva, anche della potenziale trasformazione del progetto in un articolo scientifico sottoponibile a peer review.",
...
export const COMMISSIONE_COMPOSIZIONE = [
  ...
  "Un rappresentante di SafesPro, in qualita di ente organizzatore",
...
export const COMMISSIONE_PRINCIPI = [
  ...
  "Ciascun componente e tenuto a dichiarare eventuali situazioni di conflitto di interesse rispetto a singoli progetti o team, astenendosi dalla relativa valutazione",
];

/* ── Art. 9. Presentazione dei lavori e percorso di pubblicazione ───────── */

export const PUBBLICAZIONE_INTRO =
  "Il progetto vincitore potra essere presentato nell'ambito del convegno internazionale “Vivere piu a lungo: sport e intelligenza artificiale”, che si svolgera il 10 dicembre 2026 presso il PalaMazzola di Taranto, e sara avviato a un percorso di trasformazione in pubblicazione scientifica.";
...
export const PUBBLICAZIONE_SUPPORTO = [
  ...
  "Individuazione della rivista scientifica piu appropriata",
...
export const PUBBLICAZIONE_INTEGRITA =
  "Il percorso di pubblicazione sara condotto nel rispetto dei principi di integrita scientifica, trasparenza, corretta attribuzione dei contributi e tutela della proprieta intellettuale.";
 ...
 * un errore di numerazione. Sul sito e "Art. 11", che e la numerazione
 * corretta nella sequenza.
 */
export const DISPOSIZIONI_FINALI =
  "Il presente bando ha finalita esclusivamente informativa e di invito alla partecipazione. Eventuali ulteriori modalita operative, termini di scadenza per la presentazione delle candidature e documentazione di adesione saranno comunicati dagli organizzatori tramite i canali ufficiali di Fondazione bioERGOtech e SafesPro.";
 ...
 * questo trattamento: finalita della raccolta delle candidature universitarie
 * e tempi di conservazione dei dati. Il testo sotto ricalca quello gia in uso
...
export const CONSENSO_PRIVACY_UNIVERSITA_TESTO =
  "Ho letto l'informativa e acconsento al trattamento dei miei dati personali ai sensi del Regolamento (UE) 2016/679, per le sole finalita connesse alla gestione del bando.";

export const NOTA_INTERESSI =
  "Una riga basta. Serve solo a farsi un'idea di dove vorresti lavorare, non e una proposta di progetto.";
...
export const FAQ_UNIVERSITA = [
  {
    q: "Chi puo candidarsi?",
    a: "Gli studenti universitari iscritti a corsi di laurea triennale, magistrale, a ciclo unico, dottorato di ricerca o altri percorsi universitari e post-universitari, presso universita italiane o straniere. Le aree disciplinari elencate nel bando sono indicate a titolo esemplificativo: chi studia una materia coerente con le finalita del progetto puo candidarsi.",
  },
  {
    q: "Mi candido da solo o con un gruppo?",
    a: "Da solo. La candidatura e individuale. I team di lavoro si costituiscono in un secondo momento, secondo modalita definite dagli organizzatori, e la formazione di gruppi interdisciplinari e esplicitamente incoraggiata.",
  },
  {
    q: "Quanto costa?",
    a: "Nulla. La partecipazione al percorso e completamente gratuita.",
  },
  {
  ...
  },
  {
    ...
    a: "No. Il miglior progetto viene avviato a un percorso di preparazione e proposta di pubblicazione, ma la pubblicazione resta subordinata alla qualita del lavoro, ai requisiti della rivista, al processo di peer review e all'accettazione definitiva da parte della rivista stessa.",
  },
  {
