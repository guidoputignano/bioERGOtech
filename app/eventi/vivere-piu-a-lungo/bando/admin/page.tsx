...
import { BandoAdminPanel } from "./BandoAdminPanel";

export const dynamic = "force-dynamic";

export const metadata: Metadata = {
  title: "Candidature al bando . Admin",
  robots: { index: false, follow: false },
};

export default async function BandoAdminPage() {
          ...
          <div className="container mx-auto px-6 py-16">
            <div className="card max-w-md mx-auto text-center">
              ...
              <p className="text-gray-600 mb-6">
                Questa area è riservata alla Commissione e allo staff della Fondazione. Accedi con un
                account admin.
              </p>
