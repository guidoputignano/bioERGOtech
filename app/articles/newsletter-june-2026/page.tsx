...
export default function NewsletterJune2026() {
  return (
    <main style={{ background: "#F0F2F5", minHeight: "100vh", padding: "48px 16px 80px" }}>
        ...
        <div className="nl">
          ...
          <div className="nl-body">
            ...
            <div className="nl-section">
              ...
              <div className="hubs">
                ...
                <div className="hub"><div className="hub-dot" /><div><div className="hub-city">Riyadh, Saudi Arabia</div><div className="hub-role">Clinical Translation Hub</div></div></div>
              </div>
            </div>
          ...
          <div className="nl-footer">
            ...
            <div className="footer-meta">
              ...
              info@bioergotech.org &nbsp;·&nbsp; This newsletter is sent to members and partners of the Foundation. GDPR-compliant.
            </div>
          </div>
