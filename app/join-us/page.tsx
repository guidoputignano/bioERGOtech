  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <Field label="Organisation Name" required>
        <input className={inputClass} placeholder="e.g. BioTech Solutions S.r.l." value={data.organisation_name} onChange={(e) => onChange("organisation_name", e.target.value)} />
      </Field>
      <Field label="Organisation Type" required>
        <select className={inputClass} value={data.organisation_type} onChange={(e) => onChange("organisation_type", e.target.value)}>
      ...
      <div className="grid grid-cols-2 gap-4">
        <Field label="Country" required>
          <input className={inputClass} placeholder="e.g. Italy" value={data.country} onChange={(e) => onChange("country", e.target.value)} />
        </Field>
        <Field label="City" required>
          <input className={inputClass} placeholder="e.g. Taranto" value={data.city} onChange={(e) => onChange("city", e.target.value)} />
        </Field>
      </div>
      ...
      >
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 mt-0.5">
            Receive updates, news and insights from the Foundation. You can unsubscribe at any time.
          </p>
        </div>
      </div>
          ...
          <section className="section bg-light-gray min-h-screen flex items-center justify-center">
            <div className="max-w-md mx-auto px-6 text-center">
              ...
              {form.newsletter_consent && (
                <p className="text-sm mb-8" style={{ color: "#1A9E92" }}>
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="max-w-2xl mx-auto">
              ...
              <p className="text-center text-sm text-gray-500 mt-6">
                Already a member?{" "}
                <a href="/member-portal" style={{ color: "var(--primary)", fontWeight: 600 }}>Sign in to your portal →</a>
              </p>
            </div>
          </div>
        </section>
